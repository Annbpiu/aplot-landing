export const Main = () => {
    return (
        <div className="relative pb-15 pt-25 md:pt-55">
            ...
            <div className="bg-white/20 backdrop-blur-none text-center h-[80px] md:w-[80%] z-11 flex items-center justify-center relative top-1/2 left-1/2 transform -translate-x-1/2 md:-translate-y-1/1">
