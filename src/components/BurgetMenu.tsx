...
export default function HamburgerMenu() {
    ...
    return (
        <div className="relative">
            ...
            {/* Мобільне меню */}
            <div
                className={`fixed inset-0 h-[100dvh] md:hidden bg-stone-800/90 backdrop-blur-sm z-50 flex flex-col items-end pr-5 justify-center space-y-6 ease-in transition-transform duration-300 ${isOpen ? "translate-x-0" : "translate-x-full"}`}
            >
