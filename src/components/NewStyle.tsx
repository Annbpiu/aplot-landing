...
export const NewStyle = () => {
    ...
    return (
        <div className="min-h-[100dvh] h-full mt-15 flex flex-col items-center lg:flex-col w-full bg-cover bg-no-repeat md:bg-none" style={{ backgroundImage: 'url(./Isolation_doors.svg)' }}>
            ...
            <div className="md:w-1/2 w-full h-full px-2 flex justify-center lg:self-center lg:pb-15 xl:self-end">
                ...
                {/* Слайдер */}
                <div
                    className="flex relative md:min-h-[100dvh] h-full pt-20 lg:pt-40"
                    style={{
