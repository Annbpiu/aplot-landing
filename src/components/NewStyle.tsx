...
export const NewStyle = () => {
    ...
    return (
        <div className="relative min-h-[100svh] mt-15 flex flex-col items-center lg:flex-col w-full bg-cover bg-no-repeat md:bg-none" style={{ backgroundImage: 'url(./Isolation_doors.svg)' }}>
