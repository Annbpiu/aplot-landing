...
export const Action = () => {
    ...
    return (
        <div id="diploma" className="min-h-screen relative flex flex-col items-center lg:items-start justify-around gap-20" style={{
            backgroundImage: 'url(./Decor_4.png), url(./Decor_1.png)',
            backgroundPosition: 'bottom right, top left',
            backgroundRepeat: 'no-repeat'
        }}>
            <div className="bg-black/50 m-4 mt-50 relative self-start md:h-50 md:ml-20 md:mt-20 md:w-180">
