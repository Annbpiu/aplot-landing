...
export const Action = () => {
    ...
    return (
        <div className="h-screen relative" style={{
            ...
            <div className="bg-black/50 m-4 mt-10 absolute md:h-50 md:ml-20 md:mt-60 md:w-180">
                <div className="h-full p-10 relative z-10 text-white">
                    <div className="font-light text-center md:text-xl  break-words">
                        Вся продукція заводу <span className="font-bold">«Aplot» сертифікована</span> і ми як виробник забезпечуємо гарантію якості нашої продукції.
                        Замовивши <span className="font-bold">продукцію «Аplot»</span>, ви отримаєте двері, які повністю відповідатимуть вашим уявленням про безпеку і надійність.
                    </div>
                </div>
            </div>
            ...
            {/*<div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 w-80 h-100 flex flex-col items-center justify-center">*/}
            {/*    <motion.img*/}
            {/*        key={currentDiploma}*/}
